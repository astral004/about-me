...
const Contact = () => {
  ...
  const onSubmit = (data) => {
    ...
    window.open(
      "mailto:kat7rooney@gmail.com?subject=" +
        data.name +
        " - " +
        data.email +
        "&body=" +
      ...
      <div className=" text-white px-8 max-w-6xl mx-auto">
        <div className="flex flex-col xl:flex-row justify-between items-center lg:items-center py-16">
          <div className="text-center xl:text-left mb-4">
            <h2 className="font-bold text-[40px] md:text-[72px] underline underline-offset-[5px] decoration-[#1877F2] mt-[-50px]">
              Contact Me!
            </h2>
            ...
            >
              <div className="relative">
                <input
                  ...
                  className="bg-transparent border-b py-3 outline-none w-full placeholder:text-greyish focus:border-[#1877F2] transition-all"
                  placeholder="NAME"
                />
                {errors.name ? (
                  <img
              ...
              <div className="relative mt-2">
                <textarea
                  ...
                  className="bg-transparent border-b  outline-none w-full min-h-[107px] placeholder:text-greyish focus:border-[#1877F2] transition-all resize-none"
                  placeholder="MESSAGE"
                ></textarea>
                {errors.chat ? (
                  <img
              ...
              <div className="mt-6 flex xl:justify-end xs:justify-center">
                <button className="transparent uppercase underline underline-offset-[5px] decoration-[#1877F2] hover:text-[#1877F2]">
                  SEND MESSAGE
                </button>
              </div>
            </form>
